...
export const FIXTURE_REPOS: RepoCardData[] = [
  ...
  { id: 3, full_name: 'carol/rust-kv', title: 'rust-kv', owner_login: 'carol', language: 'Rust', topics: ['kv', 'storage'], stars: 340, views: 5200, likes: 88, source: 'submitted', category: '系统底层', tagline_zh: '教学向键值存储，从日志到快照一步步搭', published_at: iso(3), cover_url: null, favorites_count: 40 },
  ...
  { id: 5, full_name: 'erin/dot-snap', title: 'dot-snap', owner_login: 'erin', language: 'Shell', topics: ['backup', 'dotfiles'], stars: 23, views: 400, likes: 6, source: 'crawled', category: '效率脚本', tagline_zh: '一条命令备份并恢复你的 dotfiles', published_at: iso(8), cover_url: null, favorites_count: 3 },
  ...
  { id: 12, full_name: 'leo/wasm-notes', title: 'wasm-notes', owner_login: 'leo', language: 'C++', topics: ['wasm'], stars: 64, views: 1100, likes: 15, source: 'submitted', category: '系统底层', tagline_zh: '从零编译到浏览器的 WASM 笔记工程', published_at: iso(60), cover_url: null, favorites_count: 10 },
]
